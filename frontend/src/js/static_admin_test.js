                    ...
                    try {
                        ...
                        if (
                            ...
                            if (entity === "Product" && !data.product_id) {
                                const newProductId =
                                    saveResult.data?.product_id?.toString() ||
                                    Date.now().toString();
                                const category = categories.find(
                                    (cat) => cat.id === data.category_id
                                ) || { name: "Uncategorized" };
                                const retailerNames = data.retail_details.map(
                                    (detail) => {
                                ...
                                products.push({
                                    ...
                                    retailer_id:
                                        data.retail_details[0]?.retailer_id ||
                                        "",
                                ...
                                if (index !== -1) {
                                    ...
                                    const retailerNames =
                                        data.retail_details.map((detail) => {
                                            const retailer = retailers.find(
                                                (r) =>
                                                    r.id === detail.retailer_id
                                            );
                                            return retailer
                                                ? retailer.name
                                                : "Unknown";
